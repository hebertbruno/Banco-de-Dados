...
int main(int argc, char *argv[]){
    ...
    while(true){
        ...
        std::cout << "(1) Dado produto<ASIN>, listar os 5 comentarios mais uteis e com maior avaliação e os 5 comentarios mais uteis e com menor avaliacao" << std::endl;
        std::cout << "(2) Dado um produto<ASIN>, listar produtos similares com maiores vendas " << std::endl;
        std::cout << "(3) Dado um produto<ASIN>, mostrar a evolução diaria das medias de avaliacao ao longo do tempo de um produto" << std::endl;
        ...
        std::cout << "(6) Listar as 5 categorias de produto com a maior media de avaliacoes uteis positivas" << std::endl;
        std::cout << "(7) Listar os 10 clientes que mais fizeram comentarios por grupo de produto" << std::endl;
        ...
        if(option == 1){
            ...
            std::cout << "Os 5 comentarios mais uteis e com maior avaliacao do produto " + asin << std::endl;
            t->add( "ID" );
            t->add( "ASIN" );
            t->add( "Customer" );
            t->add( "Date" );
